...
class _EditReservationScreenState extends State<EditReservationScreen> {
  ...
  void initState() {
    ...
    _warehouseLocationController =
        TextEditingController(text: widget.reservation.warehouseLocation);
  }
...
class ListViewWidget extends StatelessWidget {
  ...
  void _editReservation(BuildContext context, int index) async {
    ...
    if (editedReservation != null) {
      ...
      if (_reservationScreenState != null) {
        _reservationScreenState.setState(() {
          reservations[index] = editedReservation; // Update the edited reservation
        });
      }
    }
  }
          ...
          trailing: Row(
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: () => _deleteReservation(context, index), // Call delete method
              ),
            ],
          ),
          onTap: () {
